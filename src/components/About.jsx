  ...
  return (
    ...
    <div className="card aMain border-0">
      ...
      <div className="aboutInfo">
        ...
        specialize in a range of technologies including <strong>Django</strong>,{" "}
        <strong>React</strong>, <strong>Angular</strong>,{" "}
        <strong>Node.js</strong> ,<strong>MySQL</strong>, <strong>HTML</strong>,{" "}
        <strong>CSS</strong>, <strong>MongoDB</strong> and{" "}
        <strong>Bootstrap</strong>. My journey has been all about turning ideas
        into interactive, functional web applications. Beyond coding, I enjoy
        sharing knowledge and tech insights through my YouTube Channel{" - "}
        <a
